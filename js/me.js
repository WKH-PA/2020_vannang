    ...
    if (icheck_lienhe == 0) {
        ...
        $(cls).each(function () {
            ...
            if (checked === "checked" && !$(cls).is(':checked')) {
                ...
                icheck_lienhe = 0;
                return false;
            } else if (email == 1 && val != "" && (!regex.test(val) || val.length > 255)) {
                if (data_m1 != "") alert(data_m1);
                $(this).focus();
                $(".ajax_img_loading").hide();
                check = 1;
                ...
                icheck_lienhe = 0;
                return false;
            } else if (data_validate_name == 1 && !checkValidateName(val)) {
                if (data_validate_name1 != "") alert(data_validate_name1);
                $(this).focus();
                $(this).focus();
                $(".ajax_img_loading").hide();
                check = 1;
...
function checkValidateName(name) {
    ...
    // Kiểm tra chiều dài và khớp regex

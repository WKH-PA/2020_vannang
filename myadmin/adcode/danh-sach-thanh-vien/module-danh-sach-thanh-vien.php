                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p style="margin: 0;">
                                            <?php if($id_google != 0){ ?>
                                            <a style="font-size: 10px; color: #888;" target="_blank" href="<?=$google_icon ?>">
                                            <img src="<?=$google_icon ?>" alt="" style="height: 25px; width: 25px; border-radius: 100px; margin: 2px 3px 0 0;"> Google ID: <?=$id_google ?></a>
                                            <?php } ?>
                                            <?php if($id_facebook != 0){ ?>
                                            <a style="font-size: 10px; color: #888;" target="_blank" href="<?=$facebook_icon ?>">
                                            <img src="<?=$facebook_icon ?>" alt="" style="height: 25px; width: 25px; border-radius: 100px; margin: 2px 3px 0 0;"> Facebook ID: <?=$id_facebook ?></a>
                                            <?php } ?>

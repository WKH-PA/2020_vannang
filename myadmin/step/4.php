...
<div class="nav-tabs-custom">
  ...
  <div class="tab-content">
    <div class="tab-pane active" id="tab_1">
      ...
      <!-- <div class="form-group">
        <label>Địa chỉ</label>
        <input type="text" class="form-control" name="tags_vi" value="<?=!empty($tags_vi) ? Show_text($tags_vi) : "" ?>">
      </div> -->
    ...
    <div class="tab-pane" id="tab_2">
      ...
      <!-- <div class="form-group">
        ...
        <input type="text" class="form-control" name="tags_en" value="<?=!empty($tags_en) ? Show_text($tags_en) : "" ?>">
      </div> -->
      <?php if(!in_array($step, $st_bv_mota)){ ?>
      <div class="form-group">

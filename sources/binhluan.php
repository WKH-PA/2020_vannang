      ...
      <div class="page_more">
          ...
          <div class="comment_pro">
            ...
            <div class="dv-js-binhluan dv-js-binhluan-0">
              ...
              ?>
              <ul>
                <li style="background: <?=shhow_color(substr(strip_tags($rows['tenbaiviet_vi']),0, 1)) ?>;"><a><?=substr(strip_tags($rows['tenbaiviet_vi']),0, 1) ?></a></li> 
          ...
          <div class="boxComment_danhgia">
            <form action="" method="post">
              ...
              <div class="col-md-1 row-frm">
                <input type="text" name="tenbinhluan_bl" class="js_check_null_1 form-control" placeholder="<?=$glo_lang['tieu_de'] ?>">
              </div>
              <li><?=$glo_lang['viet_nhan_xet'] ?> (*):</li>
              <div class="col-md-1 row-frm">
                <textarea name="noidung_bl" class="form-control js_check_null_2" style="height:80px; padding-top:15px;" placeholder="<?=$glo_lang['viet_danh_gia'] ?>"></textarea>
                <h4>

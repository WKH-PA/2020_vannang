                ...
                <form action="<?= $full_url . "/gio-hang/" ?>" method="post" name="orderform" id="orderform">
                    ...
                    foreach ($tinhnang_arr as $rows) {
                        ...
                        while ($rows_2 = mysqli_fetch_assoc($tnoff_child)) {
                            ?>
                                    <li>
                                        <input class="js_tinhnang_getval" type="radio" name="tinhnang_<?= $i ?>" value="<?= $tinhnang_arr[$rows_2['id_val']]['id'] ?>"
                                               id="id_tn_<?= $i ?>_<?= $tinhnang_arr[$rows_2['id_val']]['tenbaiviet_' . $lang] ?>">
                                        <label for="id_tn_<?= $i ?>_<?= $tinhnang_arr[$rows_2['id_val']]['tenbaiviet_' . $lang] ?>">
                                            <?= $tinhnang_arr[$rows_2['id_val']]['tenbaiviet_' . $lang] ?></label>
                                    </li>
                                    <?php } ?>
                                </ul>
                                <div class="clr"></div>
                            ...
                            <div class="chon_size">
                                ...
                                <ul>
                                    ...
                                    for ($i = 0; $i < count(${'gia_tri_' . $k . '_vi'}); $i++) {
                                        ...
                                        ?>
                                        <li>
                                            <input class="js_tinhnang_getval" type="radio"
                                                   name="tinhnang_<?= $k ?>"

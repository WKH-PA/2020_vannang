  ...
  <?php } ?>
    ...
    <?php } ?>
      <div class="leftBox" id="proView">
          ...
          <div id="pro_img_main">
            ...
            <?php //if(count($list_hinhcon)){ ?>
              <div class="dv-slider-nang no_box">
                ...
                <div class="<?=!empty($load_ajax_all) ? "owl-auto-sp" : "owl-auto-sp-new" ?>  owl-carousel owl-theme flex" data0="<?=$data[0] ?>" data1="<?=$data[1] ?>" data2="<?=$data[2] ?>" data3="<?=$data[3] ?>" data4="<?=$data[4] ?>" data5="<?=$data[5] ?>" is_slidespeed="1000" is_navigation="1" is_dots="1" is_autoplay="1">
                  <?php if(count($list_hinhcon)){ ?>
                    <div class="item">
        ...
        <div class="viewRight">
          ...
          <ul>
          <li><a class="cur cur p_sosanh p_sosanh_<?=$arr_running['id'] ?>" onclick="load_sosanh(<?=$arr_running['id'] ?>)"><i class="fa fa-retweet"></i><?=$glo_lang['so_sanh'] ?></a></li>
          <li><a class="cur p_yeuthich  p_yeuthich_<?=$arr_running['id'] ?>" onclick="yeu_thich(this, <?=$arr_running['id'] ?>)" data="0"><i class="fa fa-heart-o"></i><?=$glo_lang['yeu_thich'] ?></a></li>
          <div class="clr"></div>
          </ul>
          </div>
            <form action="<?=$full_url."/gio-hang/" ?>" method="post" name="orderform" id="orderform">
              ...
              <div class="quantity">
                ...
                <a onclick="$('#orderform').submit()" style="cursor:pointer"><?=$glo_lang['mua_hang'] ?></a> </div>
            </form>
            <div class="clr">
          </div>
         <div id="sharelink">
    ...
    <div class="box_page_id">
      <div class="title_page_home">
        ...
        <ul>
          <li><a <?=full_href($thongtin_step) ?>><i class="fa fa-angle-double-right"></i><?=$glo_lang['xem_them'] ?></a></li>
          <div class="clr"></div>
        </ul>
        <div class="clr"></div>
      </div>

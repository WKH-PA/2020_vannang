<?php
    ...
    function GUI_email_2($to_email,$to_name,$subject,$domain,$body, $thongtin, $admin = ""){         
    ...
    GUI_email_2("linhhuynh@pavietnam.vn;linhhuynhpa2@gmail.com","to_name","subject","vannang-banok.com","body", $thongtin);
?>